...
ticket1 = Ticket.new({'customer_id' => '1', 'screening_id' => screening1.id})
ticket1.save()
ticket2 = Ticket.new({'customer_id' => '2', 'screening_id' => screening1.id})
ticket2.save()
ticket3 = Ticket.new({'customer_id' => '6', 'screening_id' => screening1.id})
ticket3.save()
ticket4 = Ticket.new({'customer_id' => '5', 'screening_id' => screening4.id})
ticket4.save()
ticket5 = Ticket.new({'customer_id' => '3', 'screening_id' => screening4.id})
ticket5.save()
ticket6 = Ticket.new({'customer_id' => '4', 'screening_id' => screening6.id})
ticket6.save()
ticket7 = Ticket.new({'customer_id' => '1', 'screening_id' => screening6.id})
ticket7.save()
ticket8 = Ticket.new({'customer_id' => '1', 'screening_id' => screening1.id})
ticket8.save()
ticket9 = Ticket.new({'customer_id' => '2', 'screening_id' => screening1.id})
ticket9.save()
